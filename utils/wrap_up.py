...
def main():
    ...
    args = parse_args()
    clade_report = f"{args.output_dir}/clade_report.tsv"
    matched_assemblies = f"{args.output_dir}/matched_assemblies.tsv"
    coverage_report = f"{args.output_dir}/coverage_report.tsv"

    clade_report = pd.read_csv(clade_report, sep="\\t")
    clade_report['clade']
